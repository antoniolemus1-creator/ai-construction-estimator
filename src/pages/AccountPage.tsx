    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e1a] via-[#0f1419] to-[#0a0e1a]">
      <nav className="border-b border-amber-900/20 bg-[#0a0e1a]/80 backdrop-blur-lg sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">Account Settings</h1>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="mt-6 text-center">
          <Button onClick={() => navigate('/billing')} variant="outline" className="border-amber-500/50 text-amber-400 hover:bg-amber-500/10">
